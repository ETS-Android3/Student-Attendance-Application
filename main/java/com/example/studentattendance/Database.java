...
public class Database extends SQLiteOpenHelper {
    ...
    //add, select, update and delete class
    ...
    // add, select, update and delete student
    ...
    //add, update, select status of student attendance
